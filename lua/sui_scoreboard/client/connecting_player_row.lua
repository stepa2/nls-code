...
function PANEL:UpdatePlayerData()
	...
	self.lblTeam:SetText( "[Подключается]" )

	self.lblHours:SetText( "" )
	self.lblGamemode:SetText( "<Подкл>" )
...
function PANEL:PerformLayout()
	...
	self.lblGamemode:SetPos( self:GetWide() - COLUMN_SIZE * 6.4, 0 )
	self.lblHours:SetPos( self:GetWide() - COLUMN_SIZE * 9.3, 0 )
